  ...
  return (
    <div className="flex flex-col justify-start">
      <div className="p-b-10">
        <TextInput {...args} placeholder="type: input" />
      </div>
      <div className="p-b-10">
        <TextInput {...args} placeholder="type: input, disabled" disabled />
      </div>
      <div className="p-b-10">
        <TextInput {...args} placeholder="type: textarea" type="textarea" />
      </div>
      <div className="p-b-10">
        <TextInput {...args} placeholder="type: password" type="password" />
      </div>
    </div>
  )
}
